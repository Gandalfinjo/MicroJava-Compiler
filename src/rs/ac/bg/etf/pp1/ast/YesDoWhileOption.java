...
public class YesDoWhileOption extends DoWhileOption {

    private Condition Condition;
    private DesignatorStatementList DesignatorStatementList;

    public YesDoWhileOption (Condition Condition, DesignatorStatementList DesignatorStatementList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("YesDoWhileOption(\n");
